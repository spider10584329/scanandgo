...
export default function LocationPage() {
  ...
  const addDetailLocation = async () => {
    ...
    try {
      ...
      console.error('Error adding detail location:', error)
  ...
  const updateDetailLocation = async (id: number, name: string) => {
    try {
      ...
      console.error('Error updating detail location:', error)
  ...
  const deleteDetailLocation = async (id: number) => {
    ...
    try {
      ...
      console.error('Error deleting detail location:', error)
      // Check if it's likely a constraint error based on the error
      const errorMessage = error instanceof Error ? error.message : ''
      if (errorMessage.includes('constraint') || errorMessage.includes('foreign key')) {
        toastError('The data cannot be deleted because it is related to other data that has inventory. To delete the data, all related inventory must be deleted.')
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Location Management</h1>
      
      {/* Four columns layout */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        
        {/* Buildings Panel */}
        <div className="bg-white rounded-lg shadow p-4 h-[calc(100vh-180px)] flex flex-col">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-gray-800 cursor-pointer hover:text-gray-600 transition-colors"
                onClick={() => {
                  setSelectedBuilding(null)
                  setSelectedArea(null)
                  setSelectedFloor(null)
          ...
          <div className="mb-4 p-3 bg-gray-50 rounded-lg">
            <div className="flex gap-2">
              ...
              <button 
                ...
                className="px-3 py-1 bg-blue-600 text-white text-sm rounded hover:bg-blue-700 disabled:cursor-not-allowed"
              >
        ...
        <div className="bg-white rounded-lg shadow p-4 h-[calc(100vh-180px)] flex flex-col">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-gray-800">
              Areas {selectedBuilding && `- ${selectedBuilding.name}`}
            </h2>
            ...
            <div className="mb-4 p-3 bg-gray-50 rounded-lg">
              <div className="flex gap-2">
                ...
                <button 
                  ...
                  className="px-3 py-1 bg-green-600 text-white text-sm rounded hover:bg-green-700 disabled:cursor-not-allowed"
                >
        ...
        <div className="bg-white rounded-lg shadow p-4 h-[calc(100vh-180px)] flex flex-col">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-gray-800">
              Floors {selectedArea && `- ${selectedArea.name}`}
            </h2>
            ...
            <div className="mb-4 p-3 bg-gray-50 rounded-lg">
              <div className="flex gap-2">
                ...
                <button 
                  ...
                  className="px-3 py-1 bg-yellow-600 text-white text-sm rounded hover:bg-yellow-700 disabled:cursor-not-allowed"
                >
        ...
        <div className="bg-white rounded-lg shadow p-4 h-[calc(100vh-180px)] flex flex-col">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-gray-800">
              Detail Locations {selectedFloor && `- ${selectedFloor.name}`}
            </h2>
            ...
            <div className="mb-4 p-3 bg-gray-50 rounded-lg">
              <div className="flex gap-2">
                ...
                <button 
                  ...
                  className="px-3 py-1 bg-purple-600 text-white text-sm rounded hover:bg-purple-700 disabled:cursor-not-allowed"
                >
                ...
                >
                  <div className="flex items-center justify-between">
                    {editingDetailLocationId === detailLocation.id ? (
                      ...
                      <>
                        <span className="text-sm font-medium flex-1">{detailLocation.name}</span>
